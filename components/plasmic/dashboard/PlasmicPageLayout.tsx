...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: O0Buw3gewmJp/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 7CgJEFYx-rPB/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: MKD47g7HjJ27/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg___0L5Nh)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__ruD1J)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___2AGgS)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox___025Zt)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__xsqJs)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
