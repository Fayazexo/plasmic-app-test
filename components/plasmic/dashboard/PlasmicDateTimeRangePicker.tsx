...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: 8NCO1Wn-VoY8/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker___0MSdb
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker___0MSdb__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__msiPm
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker__msiPm__datePickerPopup"],
                  showTime: false
                };
