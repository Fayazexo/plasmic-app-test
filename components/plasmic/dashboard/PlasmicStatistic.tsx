...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: ZDvaXRwd37ef/css
...
function PlasmicStatistic__RenderFunc(props: {
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__vSNzU)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__uRppN, {
                [sty.imghideIcon__uRppNnazfB]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__a3Tkg)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___86VFj, {
            [sty.freeBoxhideIcon___86VFJnazfB]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__yBmbz)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__zDnOf, {
              [sty.freeBoxhideTrendTracker__zDnOfUzdX]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox__pgyoJ, {
                [sty.freeBoxhideTrendTracker__pgyoJUzdX]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__ltGcG)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__u4Ibi)}>
              <div className={classNames(projectcss.all, sty.freeBox__e5WSn)}>
                {renderPlasmicSlot({
